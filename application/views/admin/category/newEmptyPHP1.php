    ...
    public function edit() {
        ...
        if($this->input->post()) {   
            ...
            try {
                ...
                $update = array('title' => $title,'published_dt'=> !empty($published_date) ? $published_date : $currentDate , 'modify_dt' => $currentDate);
        ...
        //            $config['max_height']    = 400;  
                    ...
                    /* Update Docurment */
                    $update = array('cover_image' => $coverImageFileName);
                    $this->Documents->save($update,$intSelectedId);
